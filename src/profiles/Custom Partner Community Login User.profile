...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>Business_Plan__c-Partner Business Plan Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Goals__c-Partner Goal Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Goals__c-Partner Goal Layout</layout>
    ...
    <layoutAssignments>
        <layout>Goals__c-Published Plan Goal Layout for Partners</layout>
    ...
    <objectPermissions>
        ...
        <object>Business_Plan__c</object>
